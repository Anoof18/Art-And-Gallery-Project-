                        ...
                        <div class="container">
                           <div class="slider-info ">
                              ...
                              <div class="bottom-info">
                                 <p> We provide a platform for artist to share their stories and vision . Fostering a sense of wonder and curiosity about art in community </p>
                              </div>
      ...
      <section class="about py-lg-4 py-md-3 py-sm-3 py-3" id="about">
         <div class="container py-lg-5 py-md-5 py-sm-4 py-4">
            ...
            <div class="row banner-below-w3l">
               ...
               <div class="col-lg-4 col-md-6 col-sm-6 mt-3 text-center banner-agile-flowers">
                  <img src="images/street.jpeg" width="200" height="200" class="img-thumbnail" alt="">
                  <div class="banner-right-icon">
